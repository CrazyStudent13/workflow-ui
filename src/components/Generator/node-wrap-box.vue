  ...
  <div :class="[node.type === 'start' ? 'node-wrap-box node_sid-startevent start-node' : 'node-wrap-box']">
    <div>
      <div class="title" data-spm-anchor-id="0.0.0.i2.2f244490ZxXSWD" :style="titlebg">
        <!-- <span class="iconfont">
          <svg class="" viewBox="64 64 896 896" fill="currentColor" aria-hidden="true" width="1em" height="1em"><path :d="icon" /></svg>
        </span> -->
    ...
    <AddNodeApprover :dialog.sync="dialog" :properties="node.properties" @setProperties="setProperties" />
  </div>
</template>
<script>
